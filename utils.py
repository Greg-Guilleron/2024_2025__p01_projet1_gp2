...
def ask_for_the_init_number (valid_char):
...
def ask_for_the_init_base (valid_char):
    init_number = input (ask_for_the_init_base_text)
    while not (is_a_valid_number (init_number, valid_char)) == True:
        init_number = input (ask_again_for_the_init_base_text)
    return init_number

def ask_for_the_target_base (valid_char):
    init_number = input (ask_again_for_the_target_base_text)
    while not (is_a_valid_number (init_number, valid_char)) == True:
        init_number = input (ask_again_for_the_target_base_text)
    return init_number
        
ask_for_the_init_number (hex_number_valid_chars)
ask_for_the_init_base (base_valid_chars)
ask_for_the_target_base (base_valid_chars)